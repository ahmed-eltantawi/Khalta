            ...
            return RefreshIndicator(
              ...
              child: CustomScrollView(
                slivers: [
                  ...
                  // ── From Your Fridge ──────────────────────────────────────
                  SliverToBoxAdapter(
                    child: _buildSectionTitle(context, "From Your Fridge",
                        onSeeAll: () => context.go('/fridge')),
                  ),
                  SliverToBoxAdapter(
                    child: BlocProvider(
                      create: (_) => sl<FridgeBloc>()
                        ..add(const LoadFridgeEvent())
                      ...
                      child: BlocBuilder<FridgeBloc, FridgeState>(
                        builder: (context, fridgeState) {
                          ...
                          if (fridgeState is FridgeLoaded) {
                            ...
                            if (fridgeState.perfectMatches != null)
                              allMatches.addAll(fridgeState.perfectMatches!);
                            if (fridgeState.suggestedMeals != null)
                              allMatches.addAll(fridgeState.suggestedMeals!);
                            ...
                            if (allMatches.isNotEmpty) {
                              ...
                              return Padding(
                                ...
                                child: Text(
                                    'Add ingredients to your fridge to see matching recipes here.',
                                    style: TextStyle(
